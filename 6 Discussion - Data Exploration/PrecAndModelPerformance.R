# this script compares model performance to the error in the precipation Data
...
plot(res_sum$res_sum ~ res_sum$modelPerformance, ylab = expression("e"[p]*" [mm]"),xlab = "Model performance NSE [-]", col = "red", pch = 4, lwd = 1.5)
